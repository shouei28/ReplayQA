...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: "/dashboard/activity", label: "Activity", icon: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" },
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex">
      {/* Sidebar */}
      <aside className="fixed inset-y-0 left-0 w-60 border-r border-white/10 bg-slate-950/80 backdrop-blur-sm flex flex-col">
        {/* Logo */}
        ...
        <div className="px-3 py-4 border-t border-white/10">
          <div className="flex items-center gap-3 px-3 py-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500/40 to-violet-500/40 flex items-center justify-center text-white text-xs font-bold uppercase">
          ...
          <button
            onClick={logout}
            className="mt-2 w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-400 hover:bg-white/5 hover:text-red-400 transition-colors"
          >
            <svg
              className="w-[18px] h-[18px] shrink-0"
              fill="none"
      ...
      {/* Main content */}
      <div className="ml-60 flex-1 p-8 text-white">{children}</div>
    </div>
  );
}
